            ...
            <div className="col-md-8 offset-md-2">
              ...
              <div className="card mb-5">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    <br />
                    Controlled components, on the other hand, are like a white
                    box - we manage and pass down the state to the component via
                    props. We use them when we need to have full control over
                    the component state from outside the component.
                  </p>
                </div>
              </div>
              <div className="card mb-5">
              ...
              <div className="card mb-5">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    makes it easier to handle requests and responses, parse
              ...
              <div className="card mb-5">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    A custom hook is a JavaScript function that we can create
                    and use in our React components to abstract and reuse logic
                    that we would otherwise have to write repeatedly. We use
                    custom hooks to keep our code clean, modular, and easier to
                    maintain.
                  </p>
                </div>
              </div>
