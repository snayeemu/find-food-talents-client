    ...
    <div className="container my-5 py-5">
      ...
      <Carousel style={{ maxWidth: "800px" }}>
        <Carousel.Item>
          ...
          />
          <Carousel.Caption>
            <h3 className="bg-dark bg-opacity-50 rounded py-1">John Doe</h3>
            <p className="bg-dark bg-opacity-50 rounded py-1">
        ...
        <Carousel.Item>
          ...
          />
          <Carousel.Caption>
            <h3 className="bg-dark bg-opacity-50 rounded py-1">Jane Smith</h3>
            <p className="bg-dark bg-opacity-50 rounded py-1">
        ...
        <Carousel.Item>
          ...
          />
          <Carousel.Caption>
            <h3 className="bg-dark bg-opacity-50 rounded py-1">Tom Brown</h3>
            <p className="bg-dark bg-opacity-50 rounded py-1">
